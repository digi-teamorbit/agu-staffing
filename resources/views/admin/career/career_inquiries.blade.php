                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex m-b-10 no-block">
                            <h5 class="card-title m-b-0 align-self-center">Career Submissions</h5>
                        ...
                        <div class="table-responsive m-t-10">
                            <table id="myTable" class="table color-table table-bordered product-table table-hover dataTable no-footer" role="grid" aria-describedby="myTable_info">
                                ...
                                <tbody>
								@foreach($career_inquiries as $item)	
									<tr>
									  <td class="text-center">{{ $item->id }}</td>
										...
										<td class="text-center">
                                            ...
                                            <a href="{{ url('/admin/career/inquiries/'.$item->id) }}"
                                               title="View Language">
                                            ...
                                            <a href="{{ url('/admin/career/submissions/delete',$item->id) }}"
                                               title="View Language">
