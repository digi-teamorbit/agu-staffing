          ...
          <div class="card-body">
           ...
           <div class="clearfix"></div>
            ...
            <div class="col-lg-4 col-md-4">
                <img alt="" id="input-preview" src="{{ isset($logo)?asset($logo->img_path):asset('images/upload.jpg') }}" style="width: 100%;">
            ...
            <div class="row m-b-15">
            <div class="col-lg-4 col-md-4">
                <img alt="" id="input-preview" src="{{ isset($logo2)?asset($logo2->img_path):asset('images/upload.jpg') }}" style="width: 100%;">
        <div class="upload-photo">
