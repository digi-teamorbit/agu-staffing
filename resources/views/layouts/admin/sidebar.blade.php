            ...
            <nav class="sidebar-nav ">
                <ul id="sidebarnav">
                    <li class="clearfix"></li>
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="{{url('dashboard')}}" aria-expanded="false"><i class="fas fa-address-card"></i>
                            <span class="hide-menu">Career</span></a>
                            <ul aria-expanded="false" class="collapse">
                            <li><a href="{{url('admin/career/inquiries')}}" class="">CV Submissions</a></li>
                            </ul>
                        </li>
                        ...
                        <li><a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                                        class="flaticon-restaurant"></i><span class="hide-menu">Jobs Management</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('admin/job-category')}}">Job Category</a></li>
                                <li><a href="{{url('admin/job')}}">Jobs</a></li> 
                            </ul>
                        </li>
