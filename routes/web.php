...
Route::group(['middleware' => ['auth', 'roles'],'roles' => 'admin','prefix'=>'admin'], function () {
    ...
    // career
    Route::get('career/inquiries','Admin\AdminController@careerSubmissions');
    Route::get('career/inquiries/{id}','Admin\AdminController@careershow');
    ...
    // career
    Route::any('career/submissions/delete/{id}','Admin\AdminController@careerSubmissionsDelete');
...
Route::get('/drug','HomeController@drug')->name('drug');
Route::get('/employers-resourses','HomeController@employersResources')->name('employers_resourses');
Route::get('/job-seek','HomeController@jobSeek')->name('job_seek');
Route::get('/news/{news}','HomeController@news')->name('news');
...
Route::any('/apply','HomeController@apply')->name('apply');
Route::post('career-submit','HomeController@careerSubmit')->name('careerSubmit');
...
Route::resource('admin/receiving-job', 'Admin\\ReceivingJobController');
Route::resource('admin/job-category', 'Admin\\JobCategoryController');
