...
class AdminController extends Controller
{
	...
	public function careerSubmissions() {
	 	$career_inquiries = DB::table('careers')->get();

	 	return view('admin.career.career_inquiries', compact('career_inquiries'));

	}
	
	public function careerSubmissionsDelete($id) {

		  $del = DB::table('careers')->where('id',$id)->delete();
		  
		  if($del) { 
			  return redirect('admin/career/inquiries')->with('flash_message', 'Deleted!');
		  }
    ...
    public function careershow($id)
    {
            ...
            return view('admin.career.careerdetail', compact('career'));
    }	
